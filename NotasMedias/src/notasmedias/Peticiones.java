...
public class Peticiones {
    ...
    public static Double pedirNumeroDouble(String nombreDato, Double minimo, Double maximo) {
        Double res;
        do{
        res = pedirNumeroDouble(nombreDato); 
        }while(res < minimo || res > maximo );
        return res;
    ...
    /**
     * Comprueba que el dato este comprendido entre el numero minimo y maximo.
     * @param nombreDato
     * @param minimo
     * @param maximo
     * @return 
     */
    public static Integer pedirNumeroInteger(String nombreDato,Integer minimo,Integer maximo) {
        Integer res;
        do{
        res = pedirNumeroInteger(nombreDato); 
        }while(res < minimo || res > maximo );
...
public static void formateador(String texto){
